...
Current macOS support is **stable only on macOS 11 (Big Sur) and newer**.

Compatibility work for older macOS versions is still ongoing. On systems **older than macOS 11**, some core features may behave unpredictably, including:

* Video streaming
* URL copying
* Video playback through `mpv`

These features **may partially work or fail entirely** depending on the environment.

Because of this, **v3.0.0 has been temporarily delayed** while macOS compatibility issues are investigated.

The upcoming **v3.0.0 release** will include:

* Playlist support
* A revamped **History/Bookmarks/Recent** tab
* Clickable URLs, audio streaming fixes.
